 ...
 * @author crist
 */
public class Alerta3_2 extends javax.swing.JDialog {

    /**
     * Creates new form Alerta3
     */
    public Alerta3_2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
           this.setBackground(new Color(0, 0, 0, 0)); 
        setImagenAlerta(cancelado,"src/iconos/icono5.gif");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cambios NO guardados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alerta3_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Alerta3_2 dialog = new Alerta3_2(new javax.swing.JFrame(), true);
